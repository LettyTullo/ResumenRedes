...
- **Estado S1 (Pendiente):** El cliente envió un segmento pero aún **no ha recibido confirmación (ACK)**.
- **Estado S0 (Sin pendiente):** El cliente ya recibió el acuse de recibo (**ACK**) de su último envío.

Por su parte, la entidad de transporte del servidor puede tener programado el orden de sus operaciones internas de dos formas posibles:
